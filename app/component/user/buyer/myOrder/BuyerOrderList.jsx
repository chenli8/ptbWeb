...
class Item extends Component {
    ...
    onComplete(orderId, operate) {
        ...
        } else if (operate == 'aOrderBuyerCancel') {
            this.props.onRefreshList()
        }else {
                ...
                <div className="orderInfo">
                    ...
                    <div className="middle">
                        <div className="descCon fl">
                            ...
                            <div className="subTitle">{orderInfo.orderType <= 3 ? '【服务派单】' : '【需求签单】'}</div>{/*1,2,3 服务 4 需求*/}
                            <div className="desc">
                                {orderInfo.orderDesc}
                            </div>
                            </a>
                        ...
                        <div className="statusCon fr">
                            <div className="orderStatus">
                                ...
                                {/*<i className={orderInfo.statusType === 9 ? "" : "orderStatus"+orderInfo.statusType} />*/}
                            </div>
                                ...
                                <a href="javascript:;"
                                   onClick={
                                       this.handelIsChatInfo.bind(this,
                                           {
                                               from: order.sellerInfo.userId,
                                               toUserName:shopInfoVO.shopName,
                                               toUserImage: shopInfoVO.image
                                           }
                                       )
                                   }
                                >联系卖家</a>
                    ...
                    <div className="bottom">
                        <div className="shopName fl">
                            <i className="ico-shop"></i>
                            <span>{shopInfoVO.shopName}</span>
                        </div>
                ...
                <ul className="orderInfoList">
                    {
                        state.isLoading ?
                         state.orderList.length > 0 ?
                            ...
                            :
                            <p className="noListTap"> 您还没有下单。</p>
                       :
                          null
                    }
                </ul>
